        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'school-classes', 'label' => 'Classes', 'icon' => 'fas fa-chalkboard', 'color' => 'text-info',
                 'route' => 'school-classes.index', 'active' => 'school-classes*', 'permission' => ['academics.settings.manage']],
                ['key' => 'sections', 'label' => 'Sections', 'icon' => 'fas fa-layer-group', 'color' => 'text-info',
                 'route' => 'sections.index', 'active' => 'sections*', 'permission' => ['academics.settings.manage']],
                ['key' => 'class-sections', 'label' => 'Class Sections', 'icon' => 'fas fa-sitemap', 'color' => 'text-info',
                 'route' => 'class-sections.index', 'active' => 'class-sections*', 'permission' => ['academics.settings.manage']],
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'assessment-types', 'label' => 'Assessments', 'icon' => 'fas fa-clipboard-check', 'color' => 'text-danger',
                 'route' => 'assessment-types.index', 'active' => 'assessment-types*', 'permission' => ['academics.settings.manage']],
                ...
                ['key' => 'learning-areas', 'label' => 'Learning Areas', 'icon' => 'fas fa-brain', 'color' => 'text-danger',
                 'route' => 'learning-areas.index', 'active' => 'learning-areas*', 'permission' => ['academics.settings.manage']],
            ],
        ],
