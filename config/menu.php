    ...
    */
    ...
    'sections' => [
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'academic-years', 'label' => 'Academic Years', 'icon' => 'far fa-calendar', 'color' => 'text-info',
                 'route' => 'academic-years.index', 'active' => 'academic-years*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'school-classes', 'label' => 'Classes', 'icon' => 'fas fa-chalkboard', 'color' => 'text-info',
                 'route' => 'school-classes.index', 'active' => 'school-classes*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'sections', 'label' => 'Sections', 'icon' => 'fas fa-layer-group', 'color' => 'text-info',
                 'route' => 'sections.index', 'active' => 'sections*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'class-sections', 'label' => 'Class Sections', 'icon' => 'fas fa-sitemap', 'color' => 'text-info',
                 'route' => 'class-sections.index', 'active' => 'class-sections*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'classrooms', 'label' => 'Classrooms', 'icon' => 'fas fa-door-open', 'color' => 'text-info',
                 'route' => 'classrooms.index', 'active' => 'classrooms*', 'permission' => ['academics.view', 'academics.manage']],

                ['header' => 'Curriculum', 'color' => 'text-info'],
                ['key' => 'subjects', 'label' => 'Subjects', 'icon' => 'fas fa-book-open', 'color' => 'text-info',
                 'route' => 'subjects.index', 'active' => 'subjects*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'class-subjects', 'label' => 'Class Subjects', 'icon' => 'fas fa-link', 'color' => 'text-info',
                 'route' => 'class-subjects.index', 'active' => 'class-subjects*', 'permission' => ['academics.view', 'academics.manage']],

                ['header' => 'Scheduling', 'color' => 'text-info'],
                ['key' => 'periods', 'label' => 'Periods', 'icon' => 'fas fa-clock', 'color' => 'text-info',
                 'route' => 'periods.index', 'active' => 'periods*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'timetables', 'label' => 'Master Timetables', 'icon' => 'fas fa-calendar-alt', 'color' => 'text-info',
                 'route' => 'timetables.index', 'active' => 'timetables*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'timetables-teacher', 'label' => 'Teacher Timetables', 'icon' => 'fas fa-user-clock', 'color' => 'text-info',
                 'route' => 'timetables.teacher', 'active' => 'timetables/teacher*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'academic-calendar', 'label' => 'Academic Calendar', 'icon' => 'fas fa-calendar-check', 'color' => 'text-info',
                 'route' => 'academic-calendar.index', 'active' => 'academic-calendar*', 'permission' => ['academics.view', 'academics.manage']],

                ['header' => 'Teachers', 'color' => 'text-info'],
                ['key' => 'teacher-subjects', 'label' => 'Teacher Subjects', 'icon' => 'fas fa-user-tie', 'color' => 'text-info',
                 'route' => 'teacher-subjects.index', 'active' => 'teacher-subjects*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'class-teachers', 'label' => 'Class Teachers', 'icon' => 'fas fa-chalkboard-teacher', 'color' => 'text-info',
                 'route' => 'class-teachers.index', 'active' => 'class-teachers*', 'permission' => ['academics.view', 'academics.manage']],
                ['key' => 'teacher-workload', 'label' => 'Teacher Workload', 'icon' => 'fas fa-tasks', 'color' => 'text-info',
                 'route' => 'teacher-workload.index', 'active' => 'teacher-workload*', 'permission' => ['academics.view', 'academics.manage']],
            ],
        ],
        ...
        [
            ...
            'color'    => 'text-warning',
            'active'   => ['student-dashboard*', 'students*', 'student-class-enrollments*',
            ...
            'children' => [
                ...
                ['key' => 'student-enrollments', 'label' => 'Class Enrollments', 'icon' => 'fas fa-clipboard-list', 'color' => 'text-warning',
                ...
                ['key' => 'student-attendance', 'label' => 'Student Attendance', 'icon' => 'fas fa-calendar-check', 'color' => 'text-warning',
                 'route' => 'student-attendance.index', 'active' => 'student-attendance*', 'permission' => ['academics.view', 'academics.manage']],
        ...
        [
            ...
            'color'    => 'text-danger',
            'active'   => ['exam*', 'grading-scales*', 'assessment-types*', 'exam-rooms*',
                           'grade-book*', 'mark-sheets*', 'marks-approval*', 'learning-areas*',
                           'strands*', 'competency-assessment*'],
            'permission' => ['exams.view', 'exams.manage', 'exams.approve', 'exams.import', 'exams.export',
                             'academics.view', 'academics.manage'],
            'children' => [
                ['key' => 'exam-dashboard', 'label' => 'Dashboard', 'icon' => 'fas fa-chart-line', 'color' => 'text-danger',
                 'route' => 'exam-dashboard.index', 'active' => 'exam-dashboard', 'permission' => ['exams.view']],

                ['header' => 'Configuration', 'color' => 'text-danger'],
                ['key' => 'exam-types', 'label' => 'Categories', 'icon' => 'fas fa-tags', 'color' => 'text-danger',
                 'route' => 'exam-types.index', 'active' => 'exam-types*', 'permission' => ['exams.view', 'exams.manage']],
                ['key' => 'grading-scales', 'label' => 'Grading Systems', 'icon' => 'fas fa-star-half-alt', 'color' => 'text-danger',
                 'route' => 'grading-scales.index', 'active' => 'grading-scales*', 'permission' => ['exams.view', 'exams.manage']],
                ['key' => 'assessment-types', 'label' => 'Assessments', 'icon' => 'fas fa-clipboard-check', 'color' => 'text-danger',
                 'route' => 'assessment-types.index', 'active' => 'assessment-types*', 'permission' => ['exams.view', 'exams.manage']],

                ['header' => 'Management', 'color' => 'text-danger'],
                ['key' => 'exams', 'label' => 'Sessions', 'icon' => 'fas fa-calendar-alt', 'color' => 'text-danger',
                 'route' => 'exams.index', 'active' => 'exams*', 'permission' => ['exams.view', 'exams.manage']],
                ['key' => 'exam-schedules', 'label' => 'Timetables', 'icon' => 'fas fa-clock', 'color' => 'text-danger',
                 'route' => 'exam-schedules.index', 'active' => 'exam-schedules*', 'permission' => ['exams.view', 'exams.manage']],
                ['key' => 'exam-rooms', 'label' => 'Rooms', 'icon' => 'fas fa-door-open', 'color' => 'text-danger',
                 'route' => 'exam-rooms.index', 'active' => 'exam-rooms*', 'permission' => ['exams.view', 'exams.manage']],

                ['header' => 'Marks', 'color' => 'text-danger'],
                ['key' => 'exam-results', 'label' => 'Enter Marks', 'icon' => 'fas fa-edit', 'color' => 'text-danger',
                 'route' => 'exam-results.index', 'active' => 'exam-results*', 'permission' => ['exams.view', 'exams.manage']],
                ...
                ['key' => 'grade-book', 'label' => 'Grade Book', 'icon' => 'fas fa-book', 'color' => 'text-danger',
                 'route' => 'grade-book.index', 'active' => 'grade-book*', 'permission' => ['exams.view']],
                ...
                ['key' => 'exam-reports', 'label' => 'Report Cards', 'icon' => 'fas fa-file-pdf', 'color' => 'text-danger',
                 'route' => 'exam-reports.generate', 'active' => 'exam-reports/generate*', 'permission' => ['exams.view', 'exams.export']],
                ['key' => 'exam-analysis', 'label' => 'Analysis', 'icon' => 'fas fa-chart-bar', 'color' => 'text-danger',
                 'route' => 'exam-analysis.performance', 'active' => 'exam-analysis/performance*', 'permission' => ['exams.view']],

                ['header' => 'CBC', 'color' => 'text-danger'],
                ['key' => 'learning-areas', 'label' => 'Learning Areas', 'icon' => 'fas fa-brain', 'color' => 'text-danger',
                 'route' => 'learning-areas.index', 'active' => 'learning-areas*', 'permission' => ['academics.view', 'academics.manage']],
            ],
        ],
        ...
        [
            ...
            'permission' => ['inventory.view', 'inventory.manage', 'inventory.approve', 'inventory.import', 'inventory.export'],
            'children' => [
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'book-categories', 'label' => 'Categories', 'icon' => 'fas fa-tags', 'color' => 'text-primary',
                 'route' => 'book-categories.index', 'active' => 'book-categories*', 'permission' => ['library.view', 'library.manage']],
        ...
        [
            ...
            'permission' => ['fees.view', 'fees.manage', 'fees.collect', 'fees.approve', 'fees.import', 'fees.export'],
            'children' => [
                ...
                ['key' => 'fee-categories', 'label' => 'Fee Categories', 'icon' => 'fas fa-tags', 'color' => 'text-success',
                 'route' => 'fee-categories.index', 'active' => 'fee-categories*', 'permission' => ['fees.view', 'fees.manage']],
                ...
                ['key' => 'fee-collection', 'label' => 'Collect Fees', 'icon' => 'fas fa-cash-register', 'color' => 'text-success',
                 'route' => 'fee-management.index', 'active' => 'fee-management*', 'permission' => ['fees.view', 'fees.collect']],

                ['header' => 'Reports', 'color' => 'text-success'],
                ['key' => 'fee-revenue', 'label' => 'Expected Revenue', 'icon' => 'fas fa-chart-line', 'color' => 'text-success',
                 'route' => 'fees.reports.expected-revenue', 'active' => 'fees/reports/expected-revenue', 'permission' => ['fees.view', 'fees.export']],
        ...
        [
            ...
            'children' => [
                ...
                ['key' => 'leave-types', 'label' => 'Leave Types', 'icon' => 'far fa-calendar-times', 'color' => 'text-secondary',
                 'route' => 'leave-types.index', 'active' => 'leave-types*', 'permission' => ['hr.view', 'hr.manage']],
                ...
                ['key' => 'staff-documents', 'label' => 'Documents', 'icon' => 'far fa-folder', 'color' => 'text-secondary',
                 'route' => 'staff-documents.index', 'active' => 'staff-documents*', 'permission' => ['hr.view', 'hr.manage']],
        ...
        [
            ...
            'active'   => ['finance*', 'expenses*', 'income*', 'bank*', 'budgets*',
                           'financial-reports*', 'financial-years*', 'audit-trail*'],
            ...
            'children' => [
                ...
                ['key' => 'bank-accounts', 'label' => 'Bank Accounts', 'icon' => 'fas fa-university', 'color' => 'text-primary',
                 'route' => 'bank-accounts.index', 'active' => 'bank-accounts*', 'permission' => ['finance.view', 'finance.manage']],
                ...
                ['key' => 'audit-trail', 'label' => 'Audit Trail', 'icon' => 'fas fa-history', 'color' => 'text-secondary',
                 'route' => 'audit-trail.index', 'active' => 'audit-trail*', 'permission' => ['users.view']],
