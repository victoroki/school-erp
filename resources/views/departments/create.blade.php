...
<div class="dash-wrap d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="dash-panel" style="max-width: 700px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3 class="dash-panel-title">Create New Department</h3>
                    <p class="text-muted small mb-0">Establish a new academic or administrative unit.</p>
                </div>
            </div>
            <a href="{{ route('departments.index') }}" class="btn-dash btn-ghost py-1 px-2">
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('departments.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
            <button type="submit" class="btn-dash btn-emerald-dash">
                Create Department
            </button>
        </div>
        {!! Form::close() !!}
...
.dash-control:focus { border-color: var(--emerald); box-shadow: 0 0 0 4px rgba(16, 185, 129, 0.1); outline: none; }
...
.btn-emerald-dash:hover { background: #059669; transform: translateY(-1px); }
