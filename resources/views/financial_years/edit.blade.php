...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="text-dark font-weight-bold"><i class="fas fa-edit text-secondary mr-2"></i>Edit Financial Year</h1>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="content px-3">
        <div class="card border-0 shadow-sm rounded-lg overflow-hidden">
            {!! Form::model($financialYear, ['route' => ['financial-years.update', $financialYear->id], 'method' => 'PUT']) !!}
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        {!! Form::select('status', ['open' => 'Open', 'closed' => 'Closed'], null, ['class' => 'form-control border-0 bg-light rounded-lg']) !!}
                    </div>
                    <div class="form-group col-sm-6">
            ...
            <div class="card-footer bg-light py-4 text-center">
                {!! Form::submit('Update Financial Year', ['class' => 'btn btn-secondary rounded-pill px-5 shadow-sm font-weight-bold']) !!}
