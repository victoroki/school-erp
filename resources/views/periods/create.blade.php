    ...
    <div class="dash-panel" style="max-width: 600px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3 class="dash-panel-title">Add Academic Period</h3>
                    <p class="text-muted small mb-0">Define a new time slot for the school schedule.</p>
                </div>
            </div>
            <a href="{{ route('periods.index') }}" class="btn-dash btn-ghost py-1 px-2">
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('periods.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
