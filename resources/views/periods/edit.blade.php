    ...
    <div class="dash-panel" style="max-width: 600px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3 class="dash-panel-title">Edit Academic Period</h3>
                    <p class="text-muted small mb-0">Adjust the timing or name of this schedule slot.</p>
                </div>
            </div>
        ...
        {!! Form::model($period, ['route' => ['periods.update', $period->period_id], 'method' => 'patch']) !!}
