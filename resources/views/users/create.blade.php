...
<div class="dash-wrap">
    <div class="row align-items-center mb-4">
        <div class="col-md-7">
            <h1 class="dash-heading">Create User</h1>
            <p class="dash-sub">Set up a new user account and assign roles</p>
        </div>
    ...
    <div class="dash-panel">
        ...
        <div class="dash-form-footer d-flex justify-content-end gap-2">
            ...
            {!! Form::submit('Create User', ['class' => 'btn-dash btn-primary-dash']) !!}
        </div>
        {!! Form::close() !!}
    </div>
</div>
...
/* Restyled form controls in field partial */
