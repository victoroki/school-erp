...
<div class="dash-wrap d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="dash-panel" style="max-width: 600px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                <div class="icon-wrap bg-indigo-light text-indigo">
                    <i class="fas fa-plus"></i>
                </div>
                <h3 class="dash-panel-title">Add New School Class</h3>
            </div>
            <a href="{{ route('school-classes.index') }}" class="btn-dash btn-ghost py-1 px-2">
                <i class="fas fa-times"></i>
            </a>
        </div>

        {!! Form::open(['route' => 'school-classes.store']) !!}
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('school-classes.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
...
.dash-control { border: 1px solid var(--border); border-radius: 8px; padding: 0.625rem 0.875rem; font-size: 0.875rem; transition: all 150ms var(--ease-out); color: var(--text); }
.dash-control:focus { border-color: var(--indigo); box-shadow: 0 0 0 4px rgba(79, 70, 229, 0.1); outline: none; }
.dash-control::placeholder { color: #cbd5e1; }
...
.btn-indigo-dash:hover { background: #4338ca; transform: translateY(-1px); }
