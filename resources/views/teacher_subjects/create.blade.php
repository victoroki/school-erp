...
<div class="dash-wrap d-flex align-items-center justify-content-center" style="min-height: 80vh;">
    <div class="dash-panel" style="max-width: 800px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3 class="dash-panel-title">Assign Subject to Teacher</h3>
                    <p class="text-muted small mb-0">Link a faculty member to a specific subject and class section.</p>
                </div>
            </div>
            <a href="{{ route('teacher-subjects.index') }}" class="btn-dash btn-ghost py-1 px-2">
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('teacher-subjects.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
