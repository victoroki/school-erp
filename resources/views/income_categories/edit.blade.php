    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-7">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h1 class="dash-heading">Edit Income Category</h1>
                    <p class="dash-sub">Modify existing revenue stream details</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            ...
            <div class="dash-panel">
                ...
                {!! Form::model($incomeCategory, ['route' => ['incomeCategories.update', $incomeCategory->category_id], 'method' => 'patch']) !!}
