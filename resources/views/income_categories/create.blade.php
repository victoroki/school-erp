    ...
    <div class="row align-items-center mb-4">
        <div class="col-md-7">
            <div class="d-flex align-items-center gap-3">
                <a href="{{ route('incomeCategories.index') }}" class="btn-dash btn-ghost px-3 py-2">
                    <i class="fas fa-arrow-left"></i>
                </a>
                <div>
                    <h1 class="dash-heading">New Income Category</h1>
                    <p class="dash-sub">Define a new revenue stream for the school</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            ...
            <div class="dash-panel">
                ...
                {!! Form::open(['route' => 'incomeCategories.store']) !!}
                ...
                <div class="dash-panel-footer p-3 bg-slate-light border-top d-flex justify-content-end gap-2">
                    <a href="{{ route('incomeCategories.index') }}" class="btn-dash btn-ghost"> Cancel </a>
                    <button type="submit" class="btn-dash btn-emerald-dash px-4">
...
.btn-emerald-dash:hover { background: #059669; transform: translateY(-1px); box-shadow: 0 4px 12px rgba(16, 185, 129, 0.2); color: #fff; }
