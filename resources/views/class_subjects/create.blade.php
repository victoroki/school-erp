    ...
    <div class="dash-panel" style="max-width: 900px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <div>
                    <h3 class="dash-panel-title">Class Curriculum Configuration</h3>
                    <p class="text-muted small mb-0">Select multiple subjects to assign to a specific class.</p>
                </div>
            </div>
            <a href="{{ route('class-subjects.index') }}" class="btn-dash btn-ghost py-1 px-2">
                <i class="fas fa-times"></i>
            </a>
        </div>

        {!! Form::open(['route' => 'class-subjects.store']) !!}
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('class-subjects.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
...
.dash-wrap { padding: 2.5rem; background: #fafafa; }
