    ...
    <div class="dash-panel" style="max-width: 600px; width: 100%;">
        <div class="dash-panel-header">
            <div class="d-flex align-items-center gap-2">
                ...
                <h3 class="dash-panel-title">Create New Section</h3>
            </div>
            <a href="{{ route('sections.index') }}" class="btn-dash btn-ghost py-1 px-2">
        ...
        <div class="dash-panel-footer p-4 border-top bg-light-soft d-flex justify-content-end gap-2">
            <a href="{{ route('sections.index') }}" class="btn-dash btn-ghost">
                Cancel
            </a>
