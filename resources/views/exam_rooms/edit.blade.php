...
@section('content')
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="font-weight-bold text-danger">
                        <i class="fas fa-edit mr-2"></i> Edit Exam Room
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="content px-3">
        ...
        <div class="card card-outline card-danger elevation-2 border-0">
            {!! Form::model($examRoom, ['route' => ['exam-rooms.update', $examRoom->id], 'method' => 'patch']) !!}
            <div class="card-body">
                @include('exam_rooms.fields')
            </div>
            <div class="card-footer bg-white border-top">
                {!! Form::submit('Update Room', ['class' => 'btn btn-danger px-4']) !!}
