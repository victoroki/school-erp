            ...
            @foreach($bankAccounts as $bankAccount)
                <tr>
                    ...
                    <td  style="width: 120px">
                        {!! Form::open(['route' => ['bankAccounts.destroy', $bankAccount->account_id], 'method' => 'delete']) !!}
                        <div class='btn-group'>
                            <a href="{{ route('bankAccounts.show', [$bankAccount->account_id]) }}"
                               class='btn btn-default btn-xs'>
                                <i class="far fa-eye"></i>
                            </a>
                            <a href="{{ route('bankAccounts.edit', [$bankAccount->account_id]) }}"
                               class='btn btn-default btn-xs'>
