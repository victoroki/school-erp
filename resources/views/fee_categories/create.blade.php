...
@section('content')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Optional: Auto-generate code when name loses focus if code is empty
            nameField.addEventListener('blur', function() {
                if (this.value.trim() && !codeField.value.trim()) {
                    // You could auto-generate here if desired, but for now we'll keep it manual
                }
            });
        });
    </script>
